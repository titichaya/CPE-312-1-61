...
#define C_UMAP 0x6084					//code for 'µ' character
#define C_mMap 0xb210					//code for 'm' character
#define C_nMap 0x2210					//code for 'n' character
#define star 0xA0DD						//constant code for '*' character
#define C_minus 0xA000				//constant code for '-' character
#define C_slatch  0x00c0			//constant code for '/'
#define C_percent_1 0xec00		//constant code for °
#define C_percent_2 0xb300		//constant code  for small o
#define C_full 0xffdd					//constant code  for All segment
